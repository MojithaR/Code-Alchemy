...
int main (void)
{
	...
	//total= (ammount -(ammount*discount))*noOfpersons;//calculation
	//selections
	/*if(numb==1&& (noOfpersons>100||noOfpersons>=0 ) )
	{
	...
	else if(numb==2&& (noOfpersons>100||noOfpersons>=0 ) )
	{
	...
	else if(numb==3&& (noOfpersons>100||noOfpersons>=0 ) )
	{
	...
	else if(numb>3||numb<1)
	{
		printf("Invalid input please enter correct package number !/n" );


	}
	else if(noOfpersons>100||noOfpersons<0 )
	{
		printf("sorry we donot have that much of space !/n" );
	}*/
